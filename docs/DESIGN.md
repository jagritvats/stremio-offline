# Stremio Offline — Design

> Source of truth for product intent and architecture. Implementation status is tracked in [SPIKES.md](SPIKES.md) and the root [README](../README.md).
